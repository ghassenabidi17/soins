...
class SoinsController extends AbstractController
{
    ...
    #[Route('/{idKine}', name: 'app_soins_show', methods: ['GET'])]
    ...
    #[Route('/{idKine}/edit', name: 'app_soins_edit', methods: ['GET', 'POST'])]
    ...
    #[Route('/{idKine}', name: 'app_soins_delete', methods: ['POST'])]
    public function delete(Request $request, Soins $soin, EntityManagerInterface $entityManager): Response
    {
        if ($this->isCsrfTokenValid('delete'.$soin->getIdKine(), $request->request->get('_token'))) {
